...
#ifndef _WIN32
#define DEPRECATED__cpp_pubsub__srv__ModifyMessage_Request \
...
struct ModifyMessage_Request_ {
  ...
  explicit ModifyMessage_Request_(
  ...
  Type &set__new_message(const std::basic_string<
                         char, std::char_traits<char>,
                         typename std::allocator_traits<ContainerAllocator>::
                             template rebind_alloc<char>> &_arg) {
  ...
  // pointer types
  using RawPtr = cpp_pubsub::srv::ModifyMessage_Request_<ContainerAllocator> *;
  using ConstRawPtr =
  ...
  using ConstSharedPtr = std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Request_<ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                cpp_pubsub::srv::ModifyMessage_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter = std::unique_ptr<
      cpp_pubsub::srv::ModifyMessage_Request_<ContainerAllocator>, Deleter>;
  ...
  // properly
  typedef DEPRECATED__cpp_pubsub__srv__ModifyMessage_Request std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Request_<ContainerAllocator>>
      Ptr;
  typedef DEPRECATED__cpp_pubsub__srv__ModifyMessage_Request std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Request_<ContainerAllocator> const>
...
#ifndef _WIN32
#define DEPRECATED__cpp_pubsub__srv__ModifyMessage_Response \
  __attribute__((deprecated))
#else
#define DEPRECATED__cpp_pubsub__srv__ModifyMessage_Response \
  __declspec(deprecated)
...
struct ModifyMessage_Response_ {
  ...
  explicit ModifyMessage_Response_(
      rosidl_runtime_cpp::MessageInitialization _init =
          rosidl_runtime_cpp::MessageInitialization::ALL) {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
        rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
  ...
  // pointer types
  using RawPtr = cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator> *;
  using ConstRawPtr =
      const cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator> *;
  using SharedPtr = std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator>>;
  using ConstSharedPtr = std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator> const>;

  template <typename Deleter = std::default_delete<
                cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter = std::unique_ptr<
      cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator>, Deleter>;
  ...
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes
  // properly
  typedef DEPRECATED__cpp_pubsub__srv__ModifyMessage_Response std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator>>
      Ptr;
  typedef DEPRECATED__cpp_pubsub__srv__ModifyMessage_Response std::shared_ptr<
      cpp_pubsub::srv::ModifyMessage_Response_<ContainerAllocator> const>
