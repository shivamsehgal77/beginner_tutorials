...
inline void to_flow_style_yaml(const ModifyMessage_Request& msg,
                               std::ostream& out) {
  out << "{";
  // member: new_message
  {
...
inline void to_block_style_yaml(const ModifyMessage_Request& msg,
...
inline std::string to_yaml(const ModifyMessage_Request& msg,
...
[[deprecated("use cpp_pubsub::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const cpp_pubsub::srv::ModifyMessage_Request& msg, std::ostream& out,
        size_t indentation = 0) {
  cpp_pubsub::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use cpp_pubsub::srv::to_yaml() instead")]] inline std::string
to_yaml(const cpp_pubsub::srv::ModifyMessage_Request& msg) {
...
template <>
struct is_message<cpp_pubsub::srv::ModifyMessage_Request> : std::true_type {};
...
inline void to_flow_style_yaml(const ModifyMessage_Response& msg,
                               std::ostream& out) {
  out << "{";
  // member: success
  {
...
inline void to_block_style_yaml(const ModifyMessage_Response& msg,
                                std::ostream& out, size_t indentation = 0) {
  // member: success
  {
    if (indentation > 0) {
...
inline std::string to_yaml(const ModifyMessage_Response& msg,
                           bool use_flow_style = false) {
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use cpp_pubsub::srv::to_block_style_yaml() instead")]] inline void
to_yaml(const cpp_pubsub::srv::ModifyMessage_Response& msg, std::ostream& out,
        size_t indentation = 0) {
  cpp_pubsub::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use cpp_pubsub::srv::to_yaml() instead")]] inline std::string
to_yaml(const cpp_pubsub::srv::ModifyMessage_Response& msg) {
  return cpp_pubsub::srv::to_yaml(msg);
}
...
template <>
struct is_message<cpp_pubsub::srv::ModifyMessage_Response> : std::true_type {};
...
struct has_bounded_size<cpp_pubsub::srv::ModifyMessage>
    : std::integral_constant<
          ...
          has_bounded_size<cpp_pubsub::srv::ModifyMessage_Request>::value &&
              has_bounded_size<
                  cpp_pubsub::srv::ModifyMessage_Response>::value> {};

template <>
struct is_service<cpp_pubsub::srv::ModifyMessage> : std::true_type {};
