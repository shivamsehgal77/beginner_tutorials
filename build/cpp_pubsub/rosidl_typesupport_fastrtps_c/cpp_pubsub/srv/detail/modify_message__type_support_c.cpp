// generated from
// rosidl_typesupport_fastrtps_c/resource/idl__type_support_c.cpp.em with input
...
// includes and forward declarations of message dependencies and their
...
using _ModifyMessage_Request__ros_msg_type =
...
static bool _ModifyMessage_Request__cdr_serialize(
  ...
  const _ModifyMessage_Request__ros_msg_type *ros_message =
      static_cast<const _ModifyMessage_Request__ros_msg_type *>(
          untyped_ros_message);
...
static bool _ModifyMessage_Request__cdr_deserialize(eprosima::fastcdr::Cdr &cdr,
  ...
  _ModifyMessage_Request__ros_msg_type *ros_message =
      static_cast<_ModifyMessage_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: new_message
  {
    std::string tmp;
    cdr >> tmp;
    ...
    bool succeeded = rosidl_runtime_c__String__assign(&ros_message->new_message,
                                                      tmp.c_str());
    if (!succeeded) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_pubsub size_t
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_pubsub size_t
max_serialized_size_cpp_pubsub__srv__ModifyMessage_Request(
...
using _ModifyMessage_Response__ros_msg_type =
...
static bool _ModifyMessage_Response__cdr_serialize(
  ...
  const _ModifyMessage_Response__ros_msg_type *ros_message =
      static_cast<const _ModifyMessage_Response__ros_msg_type *>(
          untyped_ros_message);
  // Field name: success
...
static bool _ModifyMessage_Response__cdr_deserialize(
  ...
  _ModifyMessage_Response__ros_msg_type *ros_message =
      static_cast<_ModifyMessage_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cpp_pubsub size_t
max_serialized_size_cpp_pubsub__srv__ModifyMessage_Response(
    bool &full_bounded, bool &is_plain, size_t current_alignment) {
  size_t initial_alignment = current_alignment;
