...
cdr_serialize(
  const cpp_pubsub::srv::ModifyMessage_Request & ros_message,
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_pubsub
max_serialized_size_ModifyMessage_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<cpp_pubsub::srv::ModifyMessage_Request *>(
    untyped_ros_message);
...
static size_t _ModifyMessage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ModifyMessage_Request(full_bounded, is_plain, 0);
...
{
  return &cpp_pubsub::srv::typesupport_fastrtps_cpp::_ModifyMessage_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_pubsub, srv, ModifyMessage_Request)() {
  return &cpp_pubsub::srv::typesupport_fastrtps_cpp::_ModifyMessage_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_pubsub
cdr_serialize(
  const cpp_pubsub::srv::ModifyMessage_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cpp_pubsub
max_serialized_size_ModifyMessage_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<cpp_pubsub::srv::ModifyMessage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _ModifyMessage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ModifyMessage_Response(full_bounded, is_plain, 0);
...
{
  return &cpp_pubsub::srv::typesupport_fastrtps_cpp::_ModifyMessage_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_pubsub, srv, ModifyMessage_Response)() {
  return &cpp_pubsub::srv::typesupport_fastrtps_cpp::_ModifyMessage_Response__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cpp_pubsub, srv, ModifyMessage)() {
  return &cpp_pubsub::srv::typesupport_fastrtps_cpp::_ModifyMessage__handle;
}
